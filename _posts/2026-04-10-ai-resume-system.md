...
This is the story of those five versions. If you're here for the how-to, there's a [companion guide](/posts/2026/04/16/build-your-own-ai-resume-pipeline/) for that. This one is just the mess.
...
If you want to build something like this yourself, the step-by-step companion guide is [here](/posts/2026/04/16/build-your-own-ai-resume-pipeline/). And if you just want to talk about it — or if you have a job for me (please) — find me on [LinkedIn](https://linkedin.com/in/tejalgoyal). I'll be there, refreshing the page, pretending I'm not.
