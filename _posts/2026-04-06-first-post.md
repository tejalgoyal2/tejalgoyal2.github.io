...
This is my first blog post, and it exists because of [GitHub Skills](https://skills.github.com/).

I was poking around GitHub looking for a way to set up a simple blog — something I could write in Markdown, push to a repo, and have it show up as an actual website. No frameworks, no hosting bills, no CMS. I found the [GitHub Pages](https://skills.github.com/courses/github-pages/) course in GitHub Skills and figured I'd try it.
...
I'm working through [Anthropic's 101 course](https://www.anthropic.com/) and building side projects to learn. Writing about what I build forces me to actually understand it — you can't explain something you only half-know. It also creates a record. I can look back in six months and see how my thinking has evolved (or cringe at how wrong I was about something).

The plan is to post about projects as I build them, share things I learn the hard way, and occasionally write about whatever else comes to mind.
...
*First post done. Next up: a write-up about building a macOS utility that technically lies about what it does.*
