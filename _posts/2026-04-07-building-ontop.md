...
...nothing. Not deprecated. Not discouraged. Just *absent*. Like Apple looked at a very obvious use case and said "no."
...
The WindowServer accepted the call, returned success, and silently did nothing. *Nothing.* No error. No exception. No "hey, you can't do that." Just... success. Everything is fine. Nothing happened.

It turns out `CGSSetWindowLevel` validates that your CG connection *owns* the target window. If it doesn't, the call is silently ignored. This is not documented anywhere. Not in headers. Not in forums. Nowhere. I found out by staring at two identical numbers and wondering if I was losing my mind.
...
*Built with Claude Code (Anthropic) · April 2026*
