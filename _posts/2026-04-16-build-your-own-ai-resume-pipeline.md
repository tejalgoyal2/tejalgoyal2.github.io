...
This is the companion post to [How I Built an AI Resume System That Actually Works](/posts/2026/04/10/ai-resume-system/). That one tells the story — the five versions, the failures, the 1 AM character counting. This one tells you *how to actually build it*.
...
**`.docx` over PDF.** ATS systems parse Word documents more reliably than PDFs. Even a beautifully formatted PDF will sometimes get mangled. The `.docx` is boring, but it passes through every system I've thrown it at.
...
**Always generate cover letters in a different chat than resumes.** If both outputs exist in the same conversation, the model will average the styles. Resume bullets get wordy. Cover letter paragraphs get clipped. I learned this across ~20 contaminated outputs before I figured out what was happening. It's subtle, it's annoying, and it's completely avoidable.
...
Have questions? Want to argue about resume formatting? Considering hiring me? (Please consider hiring me.) Find me on [LinkedIn](https://linkedin.com/in/tejalgoyal) — I'm always happy to chat about this stuff. Or anything, really. I'm on LinkedIn a lot. *A lot.*
